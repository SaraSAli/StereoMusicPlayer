There is an Android Music Player Application, using it you are able to play, pause, skip to next, skip to prevoius, shuffle or repeat any song you want to listen in your local memory. <br>
